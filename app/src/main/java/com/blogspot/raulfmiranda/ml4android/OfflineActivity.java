...
public class OfflineActivity extends AppCompatActivity {
    ...
    private class AsyncTaskRunner extends AsyncTask<Double, Integer, String> {
        ...
        protected String doInBackground(Double... params) {
            ...
            for(int r=0; r<row; r++){
                for( int c=0; c<col; c++){
                    irisMatrix[r][c]= com.blogspot.raulfmiranda.ml4android.offline.DataSet.irisData[i++];
                }
            }
...
//            System.out.println(Arrays.deepToString(irisMatrix).replace("], ", "]\n"));
            ...
            for(int r=0; r<rowLabel; r++){
                for( int c=0; c<colLabel; c++){
                    twodimLabel[r][c]= com.blogspot.raulfmiranda.ml4android.offline.DataSet.labelData[ii++];
                }
            }
